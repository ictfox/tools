...
def main(argv):
    ...
    while True:
        ...
        if is_digit(input):
            analyse_user_with_uin(input, client)
        elif is_cos_bucket_style(input):
            analyse_cos_bucket(input, client)
        elif input == "r":
            ...
            analyse_user_with_name(input, client)
